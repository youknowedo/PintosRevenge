...
@onready var top_detector_collider: CollisionShape2D = $TopOuter/CollisionShape2D
@onready var bottom_detector_collider: CollisionShape2D = $BottomOuter/CollisionShape2D
...
func _on_exit_body_exited(body: Node2D):
